...
| <a name="input_juju_offers"></a> [juju\_offers](#input\_juju\_offers) | The Juju offers provided by other charmed operators. | <pre>object({<br>    external_ingress_url : optional(string)<br>    internal_ingress_url : optional(string)<br>  })</pre> | `{}` | no |
## Outputs

...
| <a name="input_istio_route_offer_url"></a> [istio\_route\_offer\_url](#input\_istio\_route\_offer\_url) | Istio Route Offer URL | `string` | `"admin/core.istio-ingress-route"` | no |
